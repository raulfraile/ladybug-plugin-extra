...
class GuzzleMetadata extends AbstractMetadata
{

    const ICON = 'guzzle';
    const URL = 'http://guzzlephp.org/api/class-%class%.html';
    ...
    {
        return VariableWrapper::TYPE_CLASS === $data->getType() && $this->isNamespace($data->getId(), 'Guzzle');
    }
